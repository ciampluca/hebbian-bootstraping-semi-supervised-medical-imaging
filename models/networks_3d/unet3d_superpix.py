...
class UNet3D(nn.Module):
    def __init__(self, in_channels=1, out_channels=3, init_features=64):
        ...
        self.out_superpix = nn.Conv3d(features, 2, kernel_size=1)
    ...
    def forward(self, x):
        ...
        outputs = self.out_conv(dec1)
        outputs_superpix = self.out_superpix(dec1)
        return outputs, outputs_superpix
...
def unet3d_superpix(in_channels, num_classes, initialization_weights='kaiming'):
