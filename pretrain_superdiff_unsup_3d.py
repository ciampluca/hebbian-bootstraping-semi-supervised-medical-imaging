...
if __name__ == '__main__':
    ...
    for epoch in range(args.num_epochs):
        ...
        if count_iter % args.display_iter == 0:
            ...
            if args.debug:
                ...
                save_preds(score_list_train, train_eval_list[0], name_list_train, path_train_seg_results, cfg['PALETTE'], num_classes=cfg['NUM_CLASSES'])
        ...
        if count_iter % args.validate_iter == 0:
            ...
            with torch.no_grad():
                ...
                if best_val_eval_list[1] < val_eval_list[1]:
                    ...
                    save_preds(score_list_val, val_eval_list[0], name_list_val, os.path.join(path_seg_results, 'best_model'), cfg['PALETTE'], num_classes=cfg['NUM_CLASSES'])
    ...
    save_preds(score_list_val, val_eval_list[0], name_list_val, os.path.join(path_seg_results, 'last_model'), cfg['PALETTE'], num_classes=cfg['NUM_CLASSES'])
