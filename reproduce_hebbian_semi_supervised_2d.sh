        ...
        for REGIME in ${REGIMES[@]}; do
            for HEBB_MODE in ${HEBB_MODES[@]}; do
                for REP in $(seq $(( $START_REP )) $(( $REPS - 1 ))); do
                    ...
                    python test_2d.py --dataset_name $DATASET --network unet --batch_size $EVAL_BATCH_SIZE --path_dataset $DATA_ROOT/$DATASET --best JI --path_exp $EXP_ROOT/$DATASET/semi_sup/h_unet_$HEBB_MODE/inv_temp-$K/regime-$REGIME/run-$REP --hebbian_pretrain True
                    ...
                    python test_2d.py --dataset_name $DATASET --network unet --batch_size $EVAL_BATCH_SIZE --path_dataset $DATA_ROOT/$DATASET --best JI --path_exp $EXP_ROOT/$DATASET/semi_sup/h_em_unet_$HEBB_MODE/inv_temp-$K/regime-$REGIME/run-$REP --hebbian_pretrain True
                    ...
                    python test_2d.py --dataset_name $DATASET --network unet --batch_size $EVAL_BATCH_SIZE --path_dataset $DATA_ROOT/$DATASET --best JI --path_exp $EXP_ROOT/$DATASET/semi_sup/h_uamt_unet_$HEBB_MODE/inv_temp-$K/regime-$REGIME/run-$REP --hebbian_pretrain True                   
                    ...
                    python test_2d.py --dataset_name $DATASET --network unet --batch_size $EVAL_BATCH_SIZE --path_dataset $DATA_ROOT/$DATASET --best JI --path_exp $EXP_ROOT/$DATASET/semi_sup/h_cps_unet_$HEBB_MODE/inv_temp-$K/regime-$REGIME/run-$REP --hebbian_pretrain True   
                    ...
                    python test_2d.py --dataset_name $DATASET --network unet_urpc --batch_size $EVAL_BATCH_SIZE --path_dataset $DATA_ROOT/$DATASET --best JI --path_exp $EXP_ROOT/$DATASET/semi_sup/h_urpc_unet_$HEBB_MODE/inv_temp-$K/regime-$REGIME/run-$REP --hebbian_pretrain True  
                done
            done
        done
    done
