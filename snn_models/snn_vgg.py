...
class SNN_VGG(nn.Module):
    def __init__(self, img_size, input_dim, num_cls, grad_type='Linear', init='xavier'):
        super(SNN_VGG, self).__init__()

        self.gpu = True

        # Architecture parameters
        self.architecture = 'dl-vgg9'
        self.dataset = {'input_dim': input_dim, 'num_cls': num_cls}
        ...
        self.timesteps = 20
        self.leak_mem = torch.tensor(0.99)
        self.def_threshold = 1.0
        self.upsample_threshold = 1.0
        self.thl = False
        self.full_prop = False
        self.count_spikes = None
    ...
    def _make_layers(self):
        ...
        in_channels = 3 #self.dataset['input_dim']
        divisor = 1
        layer = 0
        layers, bn_layers = [], []
