...
from models.networks_3d.unet3d_cct import init_weights as init_weights_unet3d
from models.networks_3d.vnet_cct import init_weights as init_weights_vnet
