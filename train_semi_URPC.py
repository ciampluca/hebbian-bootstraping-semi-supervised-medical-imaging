...
if __name__ == '__main__':
    ...
    # TODO
    # vuole unet_urpc e non unet come modello, quindi potrebbe darci un pò fastidio quando carichiamo i pesi pre-trainati con hebbian.
    # il test non va di conseguenza
